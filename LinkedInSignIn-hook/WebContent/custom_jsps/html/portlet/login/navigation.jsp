...
<c:if test="<%= showAnonymousIcon || showCreateAccountIcon || showForgotPasswordIcon || showOpenIdIcon || showSignInIcon %>">
	<div class="navigation">
		<liferay-ui:icon-list>
			...
			String linkedInCreateOrganizationOption = com.liferay.portal.util.PrefsPropsUtil.getString(company.getCompanyId(),"linkedin.linkedincreateorganizationoption", "neverJoin");
